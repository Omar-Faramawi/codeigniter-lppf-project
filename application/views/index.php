<div class="container NoPadding" style="margin-top:30px;">
   ...
   <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
         ...
         foreach ($row['images'] as $data) {
            ?>
            <div class="item <?php if($counter == 0){ echo 'active'; } ?>" style="background-color:transparent;">
               <center>
               <img class="img img-responsive" style="height:350px;" src="<?php echo UPLOADED_IMAGES_PATH.$data->img; ?>" alt="First slide">
               <div class="container">
               </div>
               </center>
            </div>
      ...
      <div class="col-md-9 ">
         <div class="col-sm-12 FourmSection NoPadding">
            <div class="col-sm-6 NoPadding">
               ...
               <div class="col-sm-12">
                  <a href="<?= $row['links'][0]->forum; ?>"><img src="<?php echo base_url(); ?>public/img/home-fourm-icon.png"></a>
               </div>
            </div>
