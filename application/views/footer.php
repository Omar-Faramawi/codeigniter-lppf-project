   ...
   <div class="container">
      <div class="row">
         <div class="col-md-3 col-sm-4">
            ...
            <div class="col-xs-12">
               <p><span id='copyright-date'></span> © All Rights Reserved To LPPF</p>
            </div>
            <p class="clear"></p>
         </div>
         ...
         <div class="col-md-3 col-sm-12 ">
            ...
            <div class="col-sm-12">
               <p class="Rights">Proudly Created By <a href="http://www.shetewy-tech.com  ">Shetewy-Tech</a></p>
            </div>
         </div>
      </div>
   </div>
...
<script type="text/javascript">
   ...
   $(document).ready(function(){
      ...
      $('span#copyright-date').html(currentDate);
      $(".fancybox").fancybox();
