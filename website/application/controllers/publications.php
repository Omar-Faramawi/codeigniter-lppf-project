...
class Publications extends CI_Controller {
	...
	public function index()
	{
		...
		$row = array();
		$row['heading'] = $this->publicationsModel->get_publications_heading();
		$row['items'] = $this->publicationsSectionsModel->get_all_items();
		$this->load->view('header', array('title' => "Publications"));	
