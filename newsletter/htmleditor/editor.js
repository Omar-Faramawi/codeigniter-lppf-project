...
function WYSIWYG_Editor(instance_name, content, path, fwidth, fheight, styleHref, spellCheckPath){
    ...
    if(typeof(path)=='undefined'){
        this.wysiwyg_path='../htmleditor/'; // default value
    }else{
    ...
    this.wysiwyg_hidden='html_message';          // the editor's hidden field to store the HTML in for the post
