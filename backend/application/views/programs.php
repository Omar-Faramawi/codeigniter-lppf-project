            ...
            <section class="content">
               <div class="box box-info">
                  ...
                  <div class="box-body">
                     ...
                     <form role="form" method="post" action="programs/heading" enctype="multipart/form-data">
                        <!-- text input -->
               ...
               <div class="box box-info">
                  <div class="box-header with-border">
                     <h3 class="box-title">Programs items</h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
                     <?php
                           ...
                           <div class="box-footer" style="background-color:#efefef;min-height:155px;">
                              <div class="row">
                                 <div class='col-sm-12'>
                                    ...
                                    <a href="programs/delete_section/<?php echo $data->id; ?>"><i class="fa fa-trash-o"></i> delete</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <?php if($this->session->flashdata('errors-section') != ''){
                     ...
                     <form role="form" method="post" action="programs/add_program_item" enctype="multipart/form-data">
                        <!-- text input -->
                        <div class="form-group">
                           <label>Title</label>
                           <input type="text" name='title' class="form-control" placeholder="Enter ...">
                        ...
                        <div class="form-group">
                           <label>Paragraph</label>
                           <textarea class="form-control" name="paragraph-pro" rows="3" placeholder="Enter ..."></textarea>
                           <script type="text/javascript">
                                CKEDITOR.replace( 'paragraph-pro' );
                              </script>
                        </div>
                        <div class="form-group" style="margin-bottom:-14px;">
                           <div class="row">
