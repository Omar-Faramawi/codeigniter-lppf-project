            ...
            <section class="content">
               <div class="box box-info">
                  ...
                  <div class="box-body">
                     ...
                     <form role="form" method="post" action="mission/heading" enctype="multipart/form-data">
                        <!-- text input -->
               ...
               <div class="box box-info">
                  <div class="box-header with-border">
                     <h3 class="box-title">Mission sections</h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
                     <?php
                           ...
                           <div class="box-footer" style="background-color:#efefef;min-height:155px;">
                              <div class="row">
                                 <div class='col-sm-12'>
                                    ...
                                    <a href="mission/delete_section/<?php echo $data->id; ?>"><i class="fa fa-trash-o"></i> delete</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="box-body">
                    <?php if($this->session->flashdata('errors-section') != ''){
                     ...
                     <form role="form" method='post' action='mission/add_new_section' enctype="multipart/form-data">
                        <!-- text input -->
                        <div class="form-group">
                           <label>Title</label>
                           <input type="text" name="title" class="form-control" placeholder="Enter ...">
